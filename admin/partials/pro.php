<div class="wow-admin-col">	
	<div class="wow-admin-col-12">
		<p style="font-size:36px; margin-top:15px; padding-top:0px;">ADDITIONAL OPTIONS IN PRO VERSION <br/>
			<a href="https://wow-estore.com/item/side-menu-pro/" target="_blank" class="wow-btn">GET PRO VERSION <i class="fa fa-download"></i></a> <a href="https://wow-estore.com/_demo/side-menu/" target="_blank" class="wow-btn">DEMO PRO VERSION <i class="fa fa-eye"></i></a>
		</p>
	</div>	
</div>
